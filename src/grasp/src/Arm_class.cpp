...
void Arm_class::gotoTarget(geometry_msgs::PointStamped pose, double delta_x,double delta_y, double delta_z)
{
  ...
  goal_pose.pose.position.x = pose.point.x - delta_x;
  goal_pose.pose.position.y = pose.point.y - delta_y;
  goal_pose.pose.position.z = pose.point.z - delta_z;
